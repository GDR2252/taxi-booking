...
import "./LoginDriverMobileVerification.scss";

const LoginDriverMobileVerification: React.FC = () => {
  ...
  const handleOtpVerify = async (e: any) => {
    e.preventDefault();
    try {
      const res = await AuthApiServices.loginOtpVerify({ otp });
  ...
  return (
    <div className="signup-content-driver">
      <Header />
...
export default LoginDriverMobileVerification;
